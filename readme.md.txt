...
IP Address: 13.233.227.51
Host Name

Host Name: ec2-13-233-227-51.ap-south-1.compute.amazonaws.com
...
Server Configuration
    ...
    Now we use this key to log into our Amazon Lightsail server
     ...
     3. sudo ssh -i ~/.ssh/YOURFILENAME.pem ubuntu@13.233.227.51
...
then save it.(Control X, then type Y, then hit enter key on your keyboard)
    ...
    21. ssh -i ~/.ssh/udacity_key.rsa grader@13.233.227.51
...
and then log back through port 2200:
    ...
    27. ssh -i ~/.ssh/udacity_key.rsa -p 2200 grader@13.233.227.51
...
My sincere thanks to the people who poster their step-by-step on their Github: https://github.com/KSaiAkhil17h75a0502/linux_server_configuration